...
const cards = [
  {
    ...
    description: "At Excelencia International, our vision is to be a globally recognized leader in international education and im migration services. We strive to simplifythe complexities of studying abroad so that students can embark on their academic journeys with clarity and confidence.",
  ...
  },
  {
    ...
    description: "Our mission at Excelencia International is to empower every student with personalized, ethical, and professional support as they pursue educational and career goals overseas. ",
...
export default function   VisionMissionSection() {
  return (
    <section className="relative max-w-7xl mx-auto w-full  overflow-hidden py-14">
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0   w-full h-full backface-hidden bg-white rounded-3xl p-10 shadow-xl shadow-black/50 border border-slate-900/40 flex flex-col">
          ...
          <h2 className="text-4xl font-serif font-black leading-tight tracking-tight text-slate-900 mb-6">
            {card.headline}
            <br />
